...
- **Acceptance rate:** Какой % предложений принят против отклонён? Низкие показатели говорят о плохом fit или пробелах в навыках.
...
- **Velocity:** Смотрите тренды, не абсолюты. Сравнивайте с командами без агентов. (Осторожно — gameable.)
